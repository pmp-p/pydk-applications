 ...
 * The calling code is inside rmipython.c
 */
...
public class JniHandler {
    ...
    private void updateStatus(String msg) {
        if (msg.toLowerCase(java.util.Locale.ROOT).contains("error")) {
            Log.e("{{ cookiecutter.bundle }}", "Native Err: " + msg);
        } else {
            Log.i("{{ cookiecutter.bundle }}", "Native Msg: " + msg);
        }
    }
